...
import { Bricolage_Grotesque, Fraunces, Great_Vibes, IBM_Plex_Mono, IBM_Plex_Sans, Inter, JetBrains_Mono, Manrope, Oswald, Roboto, Roboto_Mono } from 'next/font/google';
import './globals.css';
