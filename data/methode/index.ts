import type { MethodeCopy } from "@/types/methode";

export const METHODE_COPY: MethodeCopy = {
  eyebrow: "La méthode",
  watermark: "CAP",
  title: "CAP : la prospérité circule déjà.",
  lead: "Back2Mboa n'est pas un catalogue de projets. C'est un filtre : chaque opportunité doit franchir trois points de contrôle avant d'atteindre un décideur, un régulateur ou un financeur.",
  pillars: [
    {
      id: "credible",
      ...
      versoTitle: "Le dossier tient debout avant d'entrer dans le pipeline.",
      versoText:
    ...
    },
    {
      ...
      versoTitle: "On peut joindre qui décide — et qui finance.",
      versoText:
    ...
    },
    {
      ...
      versoTitle: "On peut l'exécuter — jusqu'à l'impact.",
      versoText:
