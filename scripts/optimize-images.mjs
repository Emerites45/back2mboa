...
const PLAN = [
  {
    file: "Back2Mboa_Avenue_Cover.png",
  ...
  {
    file: "Official___Olivia_Mukam-WANDJI_Solutionneurs.jpg.jpeg",
    widths: [400, 800],
    quality: 85,
    opaque: false,
    out: "team",
  ...
  {
    file: "Arnold_Dinel_EKANGA.jpg.jpeg",
    widths: [400, 800],
    quality: 85,
    opaque: false,
    out: "team",
